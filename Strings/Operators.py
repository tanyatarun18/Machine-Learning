...
#this will print hellp because with 'or' we see it any of the string is true. so first hello is evaluated which is true so without going to other string it prints hello as or needs any of the string to be true.
